    ...
    const fetchProfile = async () => {
      try {
        ...
        if (userData.role === 'instructor') {
          try {
            const coursesRes = await axios.get(`${API_URL}/api/courses/my-courses`, {
              headers: { Authorization: `Bearer ${token}` }
            });
            setCourseCount(coursesRes.data.count || 0);
          } catch {
            setCourseCount(0);
          }
        }
          ...
          {profile.role === 'instructor' ? (
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  <LibraryBooksIcon sx={{ fontSize: 28, color: '#00d9b5' }} />
                </Box>
                <Typography
                  sx={{
                    fontSize: '2rem',
            ...
            <>
              <Grid item xs={12} sm={4}>
                ...
                >
                  ...
                  <Typography sx={{ fontSize: '2rem', fontWeight: 800, color: '#00d9b5' }}>
              ...
              <Grid item xs={12} sm={4}>
                ...
                >
                  ...
                  <Typography sx={{ fontSize: '2rem', fontWeight: 800, color: '#6366f1' }}>
              ...
              <Grid item xs={12} sm={4}>
                ...
                >
                  ...
                  <Typography sx={{ fontSize: '2rem', fontWeight: 800, color: '#f59e0b' }}>
                    {profile.quizResults?.length > 0
              ...
              {/* Quiz History */}
              <Grid item xs={12}>
                <Card sx={{ p: 4, background: 'rgba(255, 255, 255, 0.02)' }}>
                  <Typography
                    sx={{
                      fontSize: '1.25rem',
                      fontWeight: 700,
                  ...
                  >
                    Quiz History
                    <Box sx={{ width: 6, height: 6, bgcolor: '#00d9b5', borderRadius: '50%' }} />
                  </Typography>
                        ...
                        >
                          ...
                          <Box
                            sx={{
                              ...
                              py: 1,
                              borderRadius: '8px',
                              bgcolor: result.score >= 70 ? 'rgba(16, 185, 129, 0.1)' : 'rgba(239, 68, 68, 0.1)',
                              border: `1px solid ${result.score >= 70 ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)'}`,
                            }}
                          >
                            <Typography sx={{ fontWeight: 700, color: result.score >= 70 ? '#10b981' : '#ef4444' }}>
                              {result.score}%
                            </Typography>
                          </Box>
                        </Box>
